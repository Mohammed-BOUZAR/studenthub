                        ...
                        <div class="InnerDiv">
                            <form method="post" action="/students/login">
                                ...
                                <center>
                                    ...
                                    <p data-toggle="modal" data-target="#Sforgotpass" class="forgot-para">Forgot
                                        Password?</p>
                                </center>
                            </form>
                        </div>
...
<div class="modal fade" id="Sforgotpass" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
