  ...
  <div class="container-fluid">
    <div class="container cutm-border">
      <div class="row text-center">
        <div class="col-sm-12">
          <p class="education-para"><span class="edu">Education</span> is the most powerful weapon which you can use to change the world</p>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="col-lg-4">
          <div class="card">
            <div class="card-body">
              ...
              <p class="card-text">Focusing on a body of knowledge that is more strictly delineated and canonical than non-professional studies</p>
            </div>
          </div>
        </div>
        <div class="col-lg-4">
          <div class="card">
            <div class="card-body">
              ...
              <p class="card-text middle-card-text">Our summer session begins on 1 May and ends on 1 August</p>
            </div>
          </div>
        </div>
        <div class="col-lg-4">
          <div class="card">
            <div class="card-body">
              ...
              <p class="card-text">Understandings of the economic, cultural, political and environmental influences which shape our lives</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="container-fluid blur-bg">
    <div class="container bottom-space">
      <div class="row text-center blur-row">
        <div class="col-md-4">
          @php
          $data = DB::table('teachers')->where('status', '1')->get();
          $count = $data->count();
          @endphp
    ...
    <div class="container">
      <div class="row text-center">
        ...
        <div class="col-lg-6 career-content">
          ...
          <p class="grow-sub-text but">But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born, a complete account of the system, and expound the actual teachings of the great explorer of the truth and will unfold in the master-builder of human happiness.</p>
