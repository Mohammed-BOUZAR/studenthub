        ...
        <div class="row purchace-popup">
            <div class="col-12">
                <span class="d-block d-md-flex align-items-center">
                    <p class="text-muted"><i class="fas fa-copy bred-icons"></i> <span class="bred-line">/</span> Add
                        Result</p>
                </span>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel2">
                    ...
                    <form class="update-pro-form form-group" action="/admin/add_result" method="post"
                   ...
                   ?>
                        ...
                        <center>
                            ...
                            <button name="submit" type="submit"
                                class="btn btn-outline-primary btn-rounded profile-btns">Upload Result</button>
                        </center>
                    </form>
                </div>
            </div>
