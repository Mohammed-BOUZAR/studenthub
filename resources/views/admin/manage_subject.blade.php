        ...
        <div class="row purchace-popup">
            <div class="col-12">
                <span class="d-block d-md-flex align-items-center">
                    <p class="text-muted"><i class="fas fa-book bred-icons"></i> <span class="bred-line">/</span> Manage
                        Subjects</p>
                </span>
            </div>
        </div>
                ...
                <div class="panel panel2">
                    <div class="table-responsive">
                        <table id="dtBasicExample" class="table table-striped table-bordered" cellspacing="0"
                            ...
                            <tbody>
                                <?php
                        $query = mysqli_query($sql_con,"select *from subjects where deleted_at is null");
                        if (!$query) {
                         ...
                         ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="update_subject/<?php echo $subrow['id']; ?>"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <a href="delete_subject/<?php echo $subrow['id']; ?>"
