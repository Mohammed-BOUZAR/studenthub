                    ...
                    <div class="table-responsive">
                        <table id="dtBasicExample" class="table table-striped table-bordered" cellspacing="0"
                            ...
                            <tbody>
                                <?php
                        $userid = session('id');
                        $query = mysqli_query($sql_con,"SELECT * FROM quizresults where deleted_at is null");
                         while ($subrow = mysqli_fetch_array($query)) {
                          
                           $quzid = $subrow['quizid'];
                           $stdid = $subrow['userid'];

                           $quziquery = mysqli_query($sql_con,"select *from quizzes where id = '$quzid' and deleted_at is null");
                           if (!$quziquery) {
                           ...
                           $stdquery = mysqli_query($sql_con,"select *from students where id = '$stdid'  and deleted_at is null");
                           if (!$stdquery) {
                                    die('Query error: ' . mysqli_error($sql_con));
                                }
                         ...
                         ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="quiz_detail2/<?php echo $subrow['id']; ?>"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Delete result
                                                        </h5>
                                                    ...
                                                    <div class="modal-footer">
                                                        <a href="delete_quiz2/<?php echo $subrow['id']; ?>"
