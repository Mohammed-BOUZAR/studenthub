...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="row purchace-popup">
            <div class="col-12">
                <span class="d-block d-md-flex align-items-center">
                    <p class="text-muted"><i class="fas fa-copy bred-icons"></i> <span class="bred-line">/</span> Update
                        Result</p>
                </span>
            </div>
        </div>
        <div class="text-center file-div">
            <?php
            // $id = $_GET['value'];
            $data = mysqli_query($sql_con, "select *from results where id = '$id' and deleted_at is null");
        ...
        <div class="row text-center">
            <div class="col-md-12">
                <div class="panel panel2">
                    <form class="update-pro-form form-group" action="/admin/update_result/{{ $id }}"
                       ...
                       ?>
                        ...
                        <center>
                            ...
                            <button name="submit" type="submit"
                                class="btn btn-outline-primary btn-rounded profile-btns">Upate Result</button>
                        </center>
                    </form>
                </div>
            </div>
