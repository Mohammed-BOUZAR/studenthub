        ...
        <div class="row text-center">
            ...
            <div class="col-sm-12">
                <div class="panel">
                    <?php
                    // $tecid = $_GET['value'];
                    $data = mysqli_query($sql_con, "select *from teachers where id = '$tecid' and deleted_at is null");
                    ...
                    <hr>
                    <form onsubmit="return myfun();" class="update-pro-form"
                        action="/admin/update_teacher_profile/{{ $id }}" method="post"
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($filetype != 'jpg' && $filetype != 'png' && $filetype != 'jpeg') {
                ...
                if (isset($_GET['value'])) {
                    ...
                    echo "<script>window.location = 'teacher_profile'</script>";
                } else {
