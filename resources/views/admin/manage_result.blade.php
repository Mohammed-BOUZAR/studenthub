        ...
        <div class="row purchace-popup">
            <div class="col-12">
                <span class="d-block d-md-flex align-items-center">
                    <p class="text-muted"><i class="fas fa-copy bred-icons"></i> <span class="bred-line">/</span> Manage
                        Result</p>
                </span>
            </div>
        </div>
                          ...
                          while ($row = mysqli_fetch_array($data)) {
                           ...
                           ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="update_result/<?php echo $row['id']; ?>"
                                            class="btn btn-outline-primary btn-rounded"><i class="fa fa-edit"></i></a>
                                        <a href="" data-toggle="modal"
                                            data-target="#exampleModaldep<?php echo $row['id']; ?>"" class="btn btn-outline-danger btn-rounded" ><i class="fa fa-trash"></i></a>
